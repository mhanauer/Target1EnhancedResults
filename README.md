...
```{r}
for(i in 1:m){
datAnalysisAll[[i]]$Time = as.factor(datAnalysisAll[[i]]$Time)
}

datAnalysisWide = NULL

for(i in 1:m){
datAnalysisWide[[i]] = reshape(data = datAnalysisAll[[i]], v.names = c("Sec1Total", "Sec2Total", "Sec3Total", "Sec4Total", "Age", "Race"), timevar = "Time", direction = "wide", idvar = "ID")
}
...
Need to create a difference score
